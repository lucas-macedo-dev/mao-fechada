...
Defines the requirements for authentication form validation, error handling, and security on the login and register forms — covering client-side validation, server-side error display, password rules, and rate limiting.
