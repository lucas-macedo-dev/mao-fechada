...
Defines requirements for the guided onboarding tutorial that walks new users through the four core flows of the app, tracks their progress per-user on the backend, and surfaces contextual hints anchored to UI elements throughout the experience.
