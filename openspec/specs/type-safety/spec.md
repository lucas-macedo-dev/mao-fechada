...
Codebase-wide requirement that TypeScript and PHP code is strictly typed (no new implicit/explicit `any` or untyped PHP), enforced by compiler/linter/static-analysis configuration rather than convention alone.
