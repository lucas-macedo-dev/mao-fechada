...
Defines requirements for email verification after user registration, including sending verification emails, blocking unverified access, and allowing users to resend verification links.
