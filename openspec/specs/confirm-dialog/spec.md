...
Defines requirements for the shared `ConfirmDialog` component that replaces native browser `window.confirm` calls with a themed, accessible modal confirmation dialog.
