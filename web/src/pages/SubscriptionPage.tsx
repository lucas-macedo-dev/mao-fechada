          ...
          <Stack gap="xs">
            <Text>
              ...
              <Text component="span" fw={700}>
                {t(`subscription.plan_value.${subscription.plan_code}`, {
                  defaultValue: subscription.plan_code,
                })}
              </Text>
            </Text>
            <Text>
              ...
              <Text component="span" fw={700}>
                {t(`subscription.status_value.${subscription.status}`, {
                  ...
                  ([featureKey, feature]) => (
                    ...
                    >
                      <Group justify="space-between">
                        <Text size="sm">
                          {t(`subscription.feature.${featureKey}`, {
        ...
        <Center py="xl">
          <Stack align="center" gap="md">
            <i
              ...
              style={{ fontSize: 48, color: "var(--mantine-color-violet-6)" }}
            />
