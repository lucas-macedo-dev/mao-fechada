...
<head>
    ...
    <title>{{ __('messages.email_reset_subject') }}</title>
</head>
                    ...
                    <tr>
                        <td style="background-color:#ffffff;padding:40px 48px 32px;">
                            <h1 style="margin:0 0 8px;font-size:20px;font-weight:600;color:#1e1b4b;">
                                {{ __('messages.email_reset_heading') }}
                            </h1>
                            <p style="margin:0 0 6px;font-size:15px;color:#374151;line-height:1.6;">
                                {{ __('messages.email_reset_greeting', ['name' => $name]) }}
                            </p>
                            <p style="margin:0 0 32px;font-size:15px;color:#6b7280;line-height:1.6;">
                                {{ __('messages.email_reset_body') }}
                            </p>
                                    ...
                                    <td align="center">
                                        <a href="{{ $url }}"
                                           style="display:inline-block;background-color:#4f46e5;color:#ffffff;text-decoration:none;font-size:15px;font-weight:600;padding:14px 36px;border-radius:8px;letter-spacing:0.1px;">
                                            {{ __('messages.email_reset_action') }}
                                        </a>
                                    </td>
                                </tr>
                            </table>
                            <p style="margin:24px 0 0;font-size:13px;color:#9ca3af;line-height:1.5;text-align:center;">
                                {{ __('messages.email_reset_expiry', ['minutes' => $expireMinutes]) }}
                            </p>
                            <p style="margin:8px 0 0;font-size:13px;color:#9ca3af;line-height:1.5;text-align:center;">
                                {{ __('messages.email_reset_footer') }}
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color:#f8fafc;border-top:1px solid #e5e7eb;border-radius:0 0 12px 12px;padding:24px 48px;">
                            <p style="margin:0 0 6px;font-size:12px;color:#9ca3af;">
                                {{ __('messages.email_reset_fallback') }}
                            </p>
